...
public class ccc {
	...
	public ccc(Context var1, @NonNull ISDKJni var2) {
		this.a = var2;
		this.b = var1.getPackageName();
	}

	private JSONObject a(ddd var1) throws JSONException {
		JSONObject var6;
		var6 = new JSONObject();
		JSONArray var2;
		var2 = new JSONArray();
	...
	public void a(ddd var1, IBaseConfig var2, String var3) throws JSONException, IOException {
		ccc var10001 = this;
		JSONObject var4;
