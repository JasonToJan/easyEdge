package com.baidu.ai.edge.demo.ddktest;
 ...
 * 华为NPU 物体检测
 */
public class TestDDKDetectionTask extends BaseTestTask<Void, CharSequence, CharSequence> {
    ...
    public TestDDKDetectionTask(Context context, TextView tv, String serialNum) {
    ...
    protected CharSequence doInBackground(Void... voids) {
        ...
        try {
            for (int i = 0; i < NUM_OF_RUNS; i++) {
                ...
                DDKConfig config = new DDKConfig(context.getAssets(), "ddk");
                DDKManager manager = new DDKManager(context, config, serialNum);
