 ...
 * 高通骁龙DSP 分类
 */
public class TestSnpeClassifyTask extends BaseTestTask<Void, CharSequence, CharSequence> {
    private static final int NUM_OF_RUNS = 1;
    private static final int NUM_OF_API_CALLS = 1;

    public TestSnpeClassifyTask(Context context, TextView tv, String serialNum) {
