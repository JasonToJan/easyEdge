 ...
 * 华为NPU 分类
 */
public class TestDDKClassifyTask extends BaseTestTask<Void, CharSequence, CharSequence> {
    private static final int NUM_OF_RUNS = 1;
    private static final int NUM_OF_API_CALLS = 1;

    public TestDDKClassifyTask(Context context, TextView tv, String serialNum) {
