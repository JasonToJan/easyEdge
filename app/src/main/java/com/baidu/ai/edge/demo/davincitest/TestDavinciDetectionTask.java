 ...
 * 华为达芬奇NPU 物体检测
 */
public class TestDavinciDetectionTask extends BaseTestTask<Void, CharSequence, CharSequence> {
    ...
    public TestDavinciDetectionTask(Context context, TextView tv, String serialNum) {
